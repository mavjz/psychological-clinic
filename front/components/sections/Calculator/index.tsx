...
const Calculator = () => {
    ...
    const [therapistList, setTherapistList] =
        useState<strapiTherapistQuery[]>();
    useEffect(() => {
    ...
    useEffect(() => {
        ...
        setDiscount(
            calculation({ data, therapistList, cost, discount })?.discount
        );
    }, [data]);
    return (
        <WrapperWidth>
            ...
            <div className="calculator">
              ...
              */}
                            {therapistNameList?.map((therapistName, index) => (
                                <option
                                    value={
                                        formik.values.therapist.therapistName
                                    }
                                    key={index}
                                >
                                    {therapistName}
                    ...
                    <div className="calculator-form__relatives">
                        <label>
                            Czy ktoś z Twoich bliskich korzystał z usług
                            HumanHealth.com?
                        </label>
                        <div className="calculator-form__relatives--answer">
                            ...
                            <div className="calculator-form__question">
                                <input
                                    ...
                                    value="regular"
                                    checked={
                                        formik.values.relative === 'regular'
                                    }
                                    onChange={formik.handleChange}
                                />
